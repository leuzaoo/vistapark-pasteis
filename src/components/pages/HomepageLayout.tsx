...
export default function HomepageLayout() {
  return (
    <>
      <div className="bg-primary-red relative h-screen overflow-hidden lg:grid lg:grid-cols-2">
        ...
        <div className="relative h-full">
          <div className="flex flex-col items-center py-10 text-white">
            ...
            <p className="font-agbalumo text-primary-yellow mt-4 text-center text-7xl leading-14">
              Pastel
              <br />
